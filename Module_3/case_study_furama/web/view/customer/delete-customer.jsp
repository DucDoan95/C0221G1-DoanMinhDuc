        ...
        <div class=" row">
            ...
            <div class="col-lg-8 bg-info">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerName">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerBirthday">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerGender">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerIDCard">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerPhone">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerEmail">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="customerAddress">
                    </div>
                </div>
