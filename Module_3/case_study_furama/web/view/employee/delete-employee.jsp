        ...
        <div class=" row">
            ...
            <div class="col-lg-8 bg-info">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeeName">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeeBirthday">
                    </div>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeeIDCard">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeeSalary">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeePhone">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeeEmail">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeeAddress">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeePositionID">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly type="text" name="employeeEducationID">
                    </div>
                </div>
                <div class="row p-2">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        <input readonly="" type="text" name="employeeDivisionID">
                    </div>
                </div>
